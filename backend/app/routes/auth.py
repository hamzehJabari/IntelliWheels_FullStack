...
def get_user_from_token(token):
    ...
    # FIX: Do NOT use sanitize_string here!
    # It corrupts the '-' and '_' characters generated by secrets.token_urlsafe()
    # Parameterized queries handle SQL injection safety automatically
...
def logout():
    ...
    if token:
        # FIX: Do NOT use sanitize_string - it corrupts URL-safe tokens
        token = token.strip()[:128]
        db = get_db()
        try:
            if is_postgres():
